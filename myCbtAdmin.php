...
<div class="card" >
  ...
  <div class="card-body">
    ...
    <p class="card-text"></p>
    <a href="#" class="btn btn-primary align-center"
    >Go somewhere</a>
  </div>
</div>
</div>
...
<div class="card" >
  ...
  <div class="card-body">
    <h5 class="card-title text-center">Advert Management</h5>
    <p class="card-text"></p>
   <center> <a href="#" class="btn btn-primary align-center">Click Here</a></center>
  </div>
</div>
...
<div class="card" >
  ...
  <div class="card-body">
    <h5 class="card-title text-center">Lead Board</h5>
    <p class="card-text"></p>
    <center> <a href="#" class="btn btn-primary align-center">Click Here</a></center>
  </div>
</div>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <tbody>
   ...
   <!--  <div class="table-responsive-sm" id="dataTable">
...
<div class="modal fade" id="addQue" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="col-lg-6 col-12">
    <div class="card"  >
      <div class="card-header" >
    <center><h3 id="course">Add Exam</h3></center>
  </div>
       <div class="card-body" id="examform" >
    <div class="p-3 border-rounded" >
 ...
 <div class="col-lg-6 col-12">
    <div class="card"  >
      <div class="card-header" >
    <center><h3 id="course1">Add Exam</h3></center>
  </div>
       <div class="card-body" id="examform" >
    <div class="p-3 border-rounded" >
...
$(document).ready(function(){
  //this code inserts exam category 
  $("#login").text("logout");
  $('#Signup').hide();
