...
<body>
	...
	<div class="container-fluid  "> 
		...
		<div class="container-fluid  d-flex  ">
			<a class="navbar-brand text-primary " href="#" >NavBrand</a>
		</div></div>
...
<div class="container-fluid btnc  ">
  ...
  <div class="container-fluid  ">
    ...
    <div class="collapse navbar-collapse " id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0  ">
        ...
        <li class="nav-item mx-lg-5">
          <a class="nav-link text-light ">Contacts</a>
        </li>
      </ul>
     
    </div>  <button class="btn btn-outline-light" data-bs-toggle="modal" data-bs-target="#userLogin">Login</button>
            <button class="btn btn-outline-light mx-lg-2 " data-bs-toggle="modal" data-bs-target="#userSignup" >Signup</button>
   </div>
  </div>
...
<div class="container-fluid"  >
			<h3 class="mt-3 text-primary" style="text-align: center; font">AVAILABLE ONLINE CBT 
<br><small>GET THE WORLD CLASS & VERIFIED CBT QUESTIONS</small></h3>
...
<div class="card" >
 <img src="pume.png" style="height: 7.5em;">
  <div class="card-body">
    ...
    <p class="card-text"></p>
   <strong> <a href="#" type="button" class="btn btnc align-center text-light" data-bs-toggle="modal" data-bs-target="#exampleModal">Go somewhere</a></strong>
  </div>
</div>
</div>
...
<div class="card" >
 ...
 <img src="jamb.jpg">
  <div class="card-body" >
    ...
    <p class="card-text"></p>
    <a href="#"  type="button"  class="btn btnc align-center text-light" data-bs-toggle="modal" data-bs-target="#pgModal ">Go somewhere</a>
  </div>
</div>
</div>
...
<div class="card" >
 <img src="unilorin.jpg"  style="height: 7.5em;">
  <div class="card-body">
    ...
    <p class="card-text"></p>
    <a href="#" class="btn btnc align-center text-light">Go somewhere</a>
  </div>
</div>
</div>
...
<footer style="background-color: navy; color: white;" class="py-3 ">
	<div class="row">
		<div class="col-lg-3 mx-lg-5">
			<p><strong>Welcome to unilorin CBT Practice</strong></p>
			<hr>
			<p><small>We are here to solve students problems accademically, Start your success with US!!!!</small>
			</p>
		...
		<div class="col-lg-3 mx-lg-5">
			...
			<small><ul>
				<li><a href="">Home</a></li>
				<li><a href="">JAMB CBT</a></li>
				<li><a href="">POST UTME</a></li>
				<li><a href="">UNILORIN MOCK</a></li>
				<li><a href="">Quiz</a></li>
				<li><a href="">League</a></li>
				<li><a href="">General Mock</a></li>
        ...
        <div class="col-lg-3 mx-lg-5">
			...
			<div class="row">
				...
				<div class="col-lg-3 col-md-3 col-3">
					<i class="fab fa-twitter-square fa-2x" aria-hidden=""></i>
				</div>
				<div class="col-lg-3 col-md-3 col-3 mb-3">
					<i class="fab fa-whatsapp-square fa-2x" aria-hidden=""></i>
				</div>
				
			</div>

					<i class="fa fa-phone fa-1x " aria-hidden="true"><spna class="mx-3">+234-8100891337</spna></i>
					<address>
						<p>
						Temidire Phase 2 Ilorin Kwara
						State
						</p>
					</address>
		...
		<div class="col-lg-3 mx-lg-5">
			...
			<small><ul>
				...
				<li><a href="">What we can offer you</a></li>
...
<div  class=" text-light " style="max-width: 100%;  font-style: italic; background-color: navy "><center><p class="p-3">Dexter Tech - Copyright<b> ©</b> 2005 - 2021 Sulaiman Muhammed . All rights reserved.</p></center></div>
  ...
  <div class="modal-dialog ">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="staticBackdropLabel">Create Account with MYCBT</h5>
...
<div class=" input-group mb-3">
   ...
   <label id="cpasmsg"></label>
    ...
    <div class="col-lg-12 col-md-12 col-12 col-xs-12">
   <button type="button" name="usersignup" id="usersignup" class=" btn btn-outline-light mt-4 btnc">Submit</button>
</div>
  ...
  <div class="modal-dialog ">
    <div class="modal-content">
      ...
      <div class="col-lg-12 col-sm-6 col-m-6 container"   >
              <center class="mb-3"> <i class="fa fa-user-graduate fa-5x text-center text-primary mt-2"></i></center>

       <div class="col-lg-12 col-md-12 col-12 col-xs-12">
  	<div class=" input-group mb-3">
  	 <span class="input-group-text text-primary" id="basic-addon1"><i class="fas fa-user"></i></span>
...
<div class=" input-group mb-3">
    ...
    <input type="password" class="form-control" placeholder="enter password" aria-label="Password" name ="Password" value="">
        ...
        <button type="button" name="Login_button" id = "Login_button" class=" btn btn-primary mt-4">Login</button>
